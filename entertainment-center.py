...
movies = [schindlers_list, moneyball, avatar, the_dark_knight, shutter_island, the_hurt_locker, iron_man, grown_ups]

fresh_tomatoes.open_movies_page(movies)         #Opens list of movies in webbrowser
